...
class SMP_Log_DailyMount extends AdminController
{

    public function __construct()
    {
        parent::__construct();
        $this->assign('title', '每日坐骑日志');
    ...
    private function show(){
        ...
        foreach($data as $key => $val){
            ...
            $PackData = array(
                ...
                "vip_lv" => $val['vip_lv'],
                "mount_star" => $val['mount_star'],
                "mount_lv" => $val['mount_lv'],
            );
            $data1[] = $PackData;
        }
    ...
    private function csv_download($data)
    {
        ...
        $csv->addAll($data);
        $csv->download('log_daily_mount.csv');
    }
