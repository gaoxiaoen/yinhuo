...
class con_acc_charge{
    ...
    public function toerl($data){
        $moduleName = "data_con_acc_charge";
...
";
    ...
    public function get_erl_content($row){
        ...
        $rec = "get({$row['act_id']}) -> #base_con_acc_charge{open_info={$openInfo},act_id={$row['act_id']},reward_list=[{$content}],act_info={$actInfo} };\n";
        return $rec;
    }
