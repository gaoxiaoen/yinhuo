...
class cross_consume_rank
{
    ...
    public function toerl($data){
        $moduleName = "data_cross_consume_rank";
...
";
    ...
    public function get_erl_content($row){
        ...
        $rec = "get({$row['act_id']}) -> #base_act_cross_consume_rank{open_info={$openInfo},act_id={$row['act_id']},act_info={$actInfo} };\n";
        return $rec;
    }
