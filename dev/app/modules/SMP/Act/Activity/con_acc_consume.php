...
class con_acc_consume{
    ...
    public function toerl($data){
        $moduleName = "data_con_acc_consume";
...
";
    ...
    public function get_erl_content($row){
        ...
        $rec = "get({$row['act_id']}) -> #base_con_acc_consume{open_info={$openInfo},act_id={$row['act_id']},reward_list=[{$content}],act_info={$actInfo} };\n";
        return $rec;
    }
