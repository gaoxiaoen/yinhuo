...
class df_xunbao_lt_act{
    ...
    public function toerl($data){
        $moduleName = "data_df_xunbao_lt_act";
    ...
    public function get_erl_content($row){
        ...
        $rec = "get({$row['act_id']}) -> #base_df_xunbao_lt_act{open_info={$openInfo},act_info={$actInfo},act_id={$row['act_id']},pool_id_list=[{$row['content']}] };\n";
        return $rec;
    }
