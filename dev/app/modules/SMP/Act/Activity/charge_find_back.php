...
class charge_find_back{
    ...
    public function toerl($data){
        $moduleName = "data_charge_find_act";
...
";
    ...
    public function get_erl_content($row){
        ...
        foreach($arr as $item){
            ...
            $n = self::$count;
            $rec .= "get($n) -> #base_charge_find_act{open_info={$openInfo},act_id={$row['act_id']},gift_list = $giftlist,act_info={$actInfo} };\n";
        }
        return $rec;
    }
